...
class CombinedLoss(nn.Module):
    def __init__(self, use_boundary_loss: bool = False, dice_weight: float = 0.7, boundary_weight: float = 0.1):
        super().__init__()
...
def main():
    ...
    parser.add_argument("--input_mode", type=str, default="2d", choices=["2d", "2.5d"])
    ...
    ckpt = torch.load(os.path.join(save_dir, "checkpoints", "best.pt"), map_location=device)
